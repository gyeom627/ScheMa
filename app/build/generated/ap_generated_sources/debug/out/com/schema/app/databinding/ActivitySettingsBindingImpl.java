...
public class ActivitySettingsBindingImpl extends ActivitySettingsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_home_address, 1);
        sViewsWithIds.put(R.id.btn_change_address, 2);
        sViewsWithIds.put(R.id.edit_text_prep_time, 3);
        sViewsWithIds.put(R.id.edit_text_pre_alarm_time, 4);
        sViewsWithIds.put(R.id.button_save_settings, 5);
    }
    // views
    @NonNull
