...
public final class ActivityDebugBinding implements ViewBinding {
  ...
  private ActivityDebugBinding(@NonNull LinearLayout rootView, @NonNull TextView tvDebugOutput) {
  ...
  public static ActivityDebugBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tv_debug_output;
      TextView tvDebugOutput = ViewBindings.findChildViewById(rootView, id);
      if (tvDebugOutput == null) {
        break missingId;
      }

      return new ActivityDebugBinding((LinearLayout) rootView, tvDebugOutput);
    }
