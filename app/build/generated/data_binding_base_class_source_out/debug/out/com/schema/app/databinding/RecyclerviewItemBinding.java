...
public final class RecyclerviewItemBinding implements ViewBinding {
  ...
  private RecyclerviewItemBinding(@NonNull LinearLayout rootView, @NonNull TextView textviewDate,
  ...
  public static RecyclerviewItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RecyclerviewItemBinding((LinearLayout) rootView, textviewDate, textviewTitle);
    }
