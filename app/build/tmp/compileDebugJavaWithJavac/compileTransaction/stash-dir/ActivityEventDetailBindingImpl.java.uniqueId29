...
public class ActivityEventDetailBindingImpl extends ActivityEventDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.detail_title, 1);
        sViewsWithIds.put(R.id.detail_event_time, 2);
        sViewsWithIds.put(R.id.detail_address, 3);
        sViewsWithIds.put(R.id.detail_preparation_time, 4);
        sViewsWithIds.put(R.id.detail_travel_time, 5);
        sViewsWithIds.put(R.id.detail_final_alarm_time, 6);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.schema.app.ui.viewmodel.EventDetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.schema.app.ui.viewmodel.EventDetailViewModel ViewModel) {
